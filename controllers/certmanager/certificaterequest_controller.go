...
// +kubebuilder:rbac:groups=kms.cnrm.cloud.google.com,resources=kmscryptokeys,verbs=get;list;watch
// +kubebuilder:rbac:groups=kms.cnrm.cloud.google.com,resources=kmscryptokeys/status,verbs=get
