...
```
1a. Optionally [install kubernetes config connector](https://cloud.google.com/config-connector/docs/concepts/installation-types) to manage your gcp kms keys with k8s.
